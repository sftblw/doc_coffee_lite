defmodule DocCoffeeLiteWeb.Components.Alert do
  @moduledoc """
  DocCoffeeLiteWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
