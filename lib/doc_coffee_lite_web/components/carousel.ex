defmodule DocCoffeeLiteWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `DocCoffeeLiteWeb.Components.Carousel`
  project.
