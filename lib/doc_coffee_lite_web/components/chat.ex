defmodule DocCoffeeLiteWeb.Components.Chat do
  @moduledoc """
  `DocCoffeeLiteWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
