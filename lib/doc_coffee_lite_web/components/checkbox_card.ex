defmodule DocCoffeeLiteWeb.Components.CheckboxCard do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
