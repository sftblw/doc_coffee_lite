defmodule DocCoffeeLiteWeb.Components.CheckboxField do
  @moduledoc """
  DocCoffeeLiteWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
