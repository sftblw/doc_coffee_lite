defmodule DocCoffeeLiteWeb.Components.DeviceMockup do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.DeviceMockup` module provides a customizable component for displaying
