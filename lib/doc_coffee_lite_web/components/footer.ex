defmodule DocCoffeeLiteWeb.Components.Footer do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
