defmodule DocCoffeeLiteWeb.Components.Gallery do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Gallery` module provides a customizable gallery component for displaying
