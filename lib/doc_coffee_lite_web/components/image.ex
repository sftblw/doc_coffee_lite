defmodule DocCoffeeLiteWeb.Components.Image do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
