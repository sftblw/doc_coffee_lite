defmodule DocCoffeeLiteWeb.Components.Indicator do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Indicator` module provides a versatile component for visually highlighting
