defmodule DocCoffeeLiteWeb.Components.MegaMenu do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
