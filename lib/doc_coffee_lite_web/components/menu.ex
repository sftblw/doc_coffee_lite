defmodule DocCoffeeLiteWeb.Components.Menu do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `DocCoffeeLiteWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import DocCoffeeLiteWeb.Components.Button, only: [button_link: 1]
