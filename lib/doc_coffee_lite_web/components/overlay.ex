defmodule DocCoffeeLiteWeb.Components.Overlay do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `DocCoffeeLiteWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
