defmodule DocCoffeeLiteWeb.Components.Popover do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
