defmodule DocCoffeeLiteWeb.Components.Rating do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
