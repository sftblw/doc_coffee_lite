defmodule DocCoffeeLiteWeb.Components.ScrollArea do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
