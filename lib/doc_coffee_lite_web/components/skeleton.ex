defmodule DocCoffeeLiteWeb.Components.Skeleton do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
