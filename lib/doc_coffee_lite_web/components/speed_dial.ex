defmodule DocCoffeeLiteWeb.Components.SpeedDial do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
