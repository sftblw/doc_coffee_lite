defmodule DocCoffeeLiteWeb.Components.Spinner do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `DocCoffeeLiteWeb.Components.Spinner` module enables developers to provide
