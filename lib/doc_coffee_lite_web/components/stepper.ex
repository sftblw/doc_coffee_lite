defmodule DocCoffeeLiteWeb.Components.Stepper do
  @moduledoc """
  The `DocCoffeeLiteWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `DocCoffeeLiteWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
