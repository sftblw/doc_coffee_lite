defmodule DocCoffeeLiteWeb.Components.TableContent do
  @moduledoc """
  `DocCoffeeLiteWeb.Components.TableContent` is a component module designed to create flexible and dynamic
