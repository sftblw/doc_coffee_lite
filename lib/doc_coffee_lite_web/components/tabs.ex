defmodule DocCoffeeLiteWeb.Components.Tabs do
  @moduledoc """
  `DocCoffeeLiteWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import DocCoffeeLiteWeb.Components.Badge, only: [badge: 1]
