defmodule DocCoffeeLiteWeb.Components.ToggleField do
  @moduledoc """
  DocCoffeeLiteWeb.Components.ToggleField component renders a toggle field with customizable options.
