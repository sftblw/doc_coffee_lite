defmodule DocCoffeeLiteWeb.Components.UrlField do
  @moduledoc """
  DocCoffeeLiteWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
